...
if [ $# -eq 3 -o $# -eq 4 ]; then
    ...
    mpic++ -Wall -std=c++17 -O3 -march=native -D_BINS=$1 -D_R=$2 -D_S=$3 -D_I_S=$IS main.cpp -o ../build/search-$1-bins-$2-$3 -pthread
else
    echo "Running: mpic++ -Wall -std=c++17 -O3 -march=native -D_BINS=$1 -D_R=$2 -D_S=$3 -D_I_S=$IS main.cpp -o $6/search-$1-bins-$2-$3 -pthread"
    mpic++ -Wall -std=c++17 -O3 -march=native -D_BINS=$1 -D_R=$2 -D_S=$3 -D_I_S=$IS main.cpp -o $6/search-$1-bins-$2-$3 -pthread
fi
